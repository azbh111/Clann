...
public class NBTTagCompound extends NBTBase implements Map<String, NBTBase> {
    ...
    public String toJson(boolean withColor) {
        ...
        sb.append("{");
        if (getHandle() != null && !isEmpty()) {
            Iterator<Entry<String, NBTBase>> it = entrySet().iterator();
            Map.Entry<String, NBTBase> en;
            while (it.hasNext()) {
                en = it.next();
                if (en.getValue() != null) {
                    if (withColor) {
                        sb.append("§a").append(en.getKey()).append("§f:").append(en.getValue().toJson(withColor));
                    } else {
                        sb.append(en.getKey()).append(":").append(en.getValue().toJson(withColor));
                    }
                    if (it.hasNext()) {
                        if (withColor) {
                            sb.append("§9,§f");
    ...
    static public NBTTagCompound readGZip(File file) throws IOException {
        FileInputStream fis = new FileInputStream(file);
        Object tag = ReflectApi.NBTCompressedStreamTools_readCompressed.call(fis);
        fis.close();
        if (tag == null) {
            return null;
        }
    ...
    static public NBTTagCompound readGZip(InputStream input) {
        Object tag = ReflectApi.NBTCompressedStreamTools_readCompressed.call(input);
        if (tag == null) {
            return null;
        }
        return new NBTTagCompound(true, tag);
    ...
    final public void writeGZip(File file) throws IOException {
        if (!file.exists()) {
        ...
        ReflectApi.NBTCompressedStreamTools_writeCompressed.call(handle, fos);
        fos.close();
    }

    final public void writeGZip(OutputStream output) {
        ReflectApi.NBTCompressedStreamTools_writeCompressed.call(handle, output);
    }
    ...
    public Byte getByte(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagByte) {
            return ((NBTTagByte) t).get();
        }
        return null;
    }
    ...
    public Short getShort(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagShort) {
            return ((NBTTagShort) t).get();
        }
        return null;
    }
    ...
    public Integer getInt(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagInt) {
            return ((NBTTagInt) t).get();
        }
        return null;
    }
    ...
    public Long getLong(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagLong) {
            return ((NBTTagLong) t).get();
        }
        return null;
    }
    ...
    public Double getDouble(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagDouble) {
            return ((NBTTagDouble) t).get();
        }
        return null;
    }
    ...
    public int[] getIntArray(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagIntArray) {
            return ((NBTTagIntArray) t).get();
        }
        return null;
    }
    ...
    public byte[] getByteArray(String key) {
        NBTBase t = get(key);
        if (t instanceof NBTTagByteArray) {
            return ((NBTTagByteArray) t).get();
        }
        return null;
    }
    ...
    /**
     * Get compound by key. If not exist create new compound and append to this
     *
     * @param key key
     * @return compound
     */
    ...
    /**
     * Get list by key. If not exist create new list and append to this
     *
     * @param key key
     * @return list
     */
    ...
    private class WrapEntrySet extends AbstractSet<Entry<String, NBTBase>> {
        ...
        public boolean containsAll(Collection<?> c) {
            ...
            for (Object t : c) {
                bases.add(NBTBase.getByValue(t).handle);
            }
