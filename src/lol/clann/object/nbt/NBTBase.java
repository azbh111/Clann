...
public abstract class NBTBase {
    ...
    protected Object handle;  //这个是MC里面的NBT类

    public static NBTBase fromJson(String json) {
        return JsonToNBT.wrap(json);
    }

    public String toJson(boolean withColor) {
        if (withColor) {
            return "§c" + getHandle().toString() + "§f";
        }
    ...
    public static NBTBase getByValue(Object o) {
        ...
        if (o instanceof CharSequence) {
            return new NBTTagString(o.toString());
        }
        if (o instanceof int[]) {
