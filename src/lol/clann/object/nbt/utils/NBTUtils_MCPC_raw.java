...
final class NBTUtils_MCPC_raw extends NBTUtils {
    ...
    private RefConstructor con_NBTagByte = class_NBTTagByte.getConstructor(new Object[]{byte.class});
    private RefConstructor con_NBTagShort = class_NBTTagShort.getConstructor(new Object[]{short.class});
    private RefConstructor con_NBTagInt = class_NBTTagInt.getConstructor(new Object[]{int.class});
    private RefConstructor con_NBTagLong = class_NBTTagLong.getConstructor(new Object[]{long.class});
    private RefConstructor con_NBTagFloat = class_NBTTagFloat.getConstructor(new Object[]{float.class});
    private RefConstructor con_NBTagDouble = class_NBTTagDouble.getConstructor(new Object[]{double.class});
    private RefConstructor con_NBTagString = class_NBTTagString.getConstructor(new Object[]{String.class});
    private RefConstructor con_NBTagByteArray = class_NBTTagByteArray.getConstructor(new Object[]{byte[].class});
    private RefConstructor con_NBTagIntArray = class_NBTTagIntArray.getConstructor(new Object[]{int[].class});
    private RefConstructor con_NBTagCompound = class_NBTTagCompound.getConstructor(new Object[0]);
    private RefConstructor con_NBTagList = class_NBTTagList.getConstructor(new Object[0]);
