...
public class AFKListener implements Listener {
    ...
    public void PlayerInteractEvent(PlayerInteractEvent event) {
        if (plugin.afkdata.getLastAction(event.getPlayer().getName()) != AFKData.actions.get("pInteract")) {
            plugin.afkdata.logAction(event.getPlayer().getName(), "pInteract");//随机性强的事件,连续触发视为一次
        }
    }
