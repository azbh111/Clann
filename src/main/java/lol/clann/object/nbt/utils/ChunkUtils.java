...
public class ChunkUtils {
    ...
    public RefField fChunkProvider;
    public RefField fChunkLoader;
    public RefField fChunks;
    public RefMethod mGetChunkHandle;
    public RefMethod mGetWorldHandle;
    public RefMethod mSaveChunk;
    public RefMethod mLoadChunk;
    public RefMethod mLoadEntities;
    public RefMethod mPutToMap;
    public RefMethod mAddEntities;
    public RefMethod mLoadNearby;
    ...
    private void writeChunk(Chunk chunk, Object nbtTagCompound, boolean unsafe){
        ...
        task.run();
        Bukkit.getScheduler().runTaskLater(Clann.plugin, task, 2);
        // refresh blocks
